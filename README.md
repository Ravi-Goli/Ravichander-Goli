...
**Other:** `Git` `Swagger` `JPA` `Entity Framework`
...
Built **LedgerForge**, a multi-language billing platform starter that combines a **React Native mobile app**, a **Java billing engine**, and a **Python analytics module** in one cohesive repository.

**Key Highlights:**
- Designed a branded mobile shell for billing and account workflows using **React Native + Expo**.
- Added a **Java billing domain engine** for invoice summarization, outstanding exposure analysis, and collection metrics.
- Added a **Python analytics layer** for revenue forecasting and collection-risk scoring.
- Structured the repo as a platform foundation that can grow into subscriptions, invoices, payments, and account intelligence flows.
